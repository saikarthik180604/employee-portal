    ...
    <div className="emp-container" style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#000' }}>
      ...
      <div className="main-area" style={{ 
        ...
        <div className="content" style={{ padding: '30px' }}>
          ...
          {active === "jobsearch" && <JobSearch user={dbUser || user} />}
          {active === "offer" && <OfferAcceptance user={dbUser || user} />}
          {active === "training" && <TrainingLearning session={{ user: dbUser || user }} />}
          {active === "leave" && <LeaveRequest user={dbUser || user} />}
          {active === "career" && <CareerDevelopment user={dbUser || user} />}
          {active === "grievance" && <Grievance user={dbUser || user} />}
          {active === "exit" && <ExitRequest user={dbUser || user} />}
                  ...
                  <div className="glass-card" style={{padding:'25px', background: 'rgba(255,255,255,0.03)', borderRadius: '15px', border: '1px solid rgba(255,255,255,0.05)'}}>
                    ...
                    <div style={{marginBottom: '20px', padding: '15px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: '1px dashed rgba(255,255,255,0.1)'}}>
                        ...
                        {isEditing ? (
                            ...
                            ) : <p style={{color: '#ff4d4d', fontSize: '13px', margin: 0}}>No document uploaded</p>
                        )}
                    </div>
